    ...
    <div className="min-h-screen bg-white lg:bg-[#F9F7FF] flex flex-col lg:flex-row items-center justify-center p-6 lg:p-12 gap-12">
      ...
      <div className="w-full max-w-sm lg:max-w-md lg:bg-white lg:p-12 lg:rounded-[3rem] lg:shadow-2xl border border-transparent lg:border-gray-50 shrink-0">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-[#1E1B4B] mb-2">Welcome Back! 👋</h1>
          <p className="text-[#4a4273] font-medium">Login to continue</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mb-6">
          ...
          <div className="flex justify-end pt-1">
            <button type="button" className="text-[#F52B91] text-sm font-bold hover:underline">
              Forgot Password?
            </button>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 rounded-2xl bg-[#F52B91] text-white font-bold text-lg shadow-lg shadow-[#F52B91]/30 hover:bg-[#d8217d] transition-colors flex items-center justify-center mt-2 disabled:opacity-50"
          >
        ...
        <div className="relative flex items-center justify-center mb-6">
          ...
          <span className="bg-white lg:bg-transparent px-4 text-xs font-bold text-gray-400 relative z-10">or continue with</span>
        </div>
        ...
        <p className="text-center text-sm font-medium text-gray-500">
          ...
          <Link to="/signup" className="text-[#F52B91] font-bold hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
